                    ...
                    <div class="col-lg-8 text-end d-flex justify-content-end">
                        ...
                        <div class="dropdown ms-2">
                            ...
                            <ul name="sort" class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <li><a class="dropdown-item"
                                        href="{{ route('client', ['sort_by' => 'name', 'sort_order' => 'asc']) }}">A - Z</a>
                                </li>
                                <li><a class="dropdown-item"
                                        href="{{ route('client', ['sort_by' => 'name', 'sort_order' => 'desc']) }}">Z -
                                        A</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('client', ['sort_by' => 'price', 'sort_order' => 'asc']) }}">price :
                                        Low - High</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('client', ['sort_by' => 'price', 'sort_order' => 'desc']) }}">price :
                                        High - Low</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('client', ['sort_by' => 'created_at', 'sort_order' => 'desc']) }}">Date
                                        : Latest - Oldest</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('client', ['sort_by' => 'created_at', 'sort_order' => 'asc']) }}">Date
                                        : Oldest - Latest</a></li>
                            </ul>
                        </div>
                                                ...
                                                <form action="{{ route('cart.addToCart') }}" method="post">
                                                    ...
                                                    <div class="rounded position-relative fruite-item">
                                                        ...
                                                        <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                            style="top: 10px; left: 10px;">{{ $item->category->name }}
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="d-flex justify-content-center flex-lg-wrap">
                                                                <h4 class="text-dark  fw-bold mb-0">{{ $item->price }}MMK
                                                                </h4>
                                                                <button type="submit"
